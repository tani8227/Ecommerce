        ...
        <Box padding={0}  >
            <Grid container sx={{ xs: { display: 'flex', flexWrap: "wrap" }, justifyContent: "center", }} >
                 {mobileData && mobileData.map((ele, index) => (
                    ...
                    <Grid key={ele._id} item xs={12} padding={0} sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, justifyContent: { xs: "center", md: "space-evenly" }, alignItems: { xs: "center" }, borderTop: "1px solid lightgrey" }}>
