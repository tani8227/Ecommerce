...
export const SellerSignInComponent = () => {
    ...
    async function handlesubmit(e) {
        ...
        try {
            ...
            const response = await fetch("http://localhost:8000/api/v1/seller/create-session",
                {
                    method: "POST",
                    headers:
                    {
    ...
    return (
        <Grid container sx={{ display: 'flex', justifyContent: 'center', alignItems: "center", alignContent: "center", m: 2 }}>
